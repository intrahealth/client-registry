...
export default {
  ...
  data() {
    return {
      ...
      fields: { 
        source: this.$t('submitting_system'), 
        source_id: this.$t('source_id'), 
        family: this.$t('surname'), 
        given: this.$t('given_names'),
        gender: this.$t('gender'), 
        birthDate: this.$t('birth_date'), 
        phone: this.$t('phone'), 
        nationality: this.$t('nationality'),
        marital_status: this.$t('marital_status'), 
        registering_facility: this.$t('registering_facility'),
        village : this.$t('village'),
        parish : this.$t('parish'),
        county : this.$t('county'),
        sub_county : this.$t('sub_county'),
        district : this.$t('district'),
        country_of_residence : this.$t('country_of_residence'),
        next_of_kin : this.$t('next_of_kin'),
      },
      score_matrix: [],
