...
const ES_BASE_URL = URI(config.get("elastic:server"))
...
describe("Testing express", () => {
  ...
  test("Testing UnBreaking Matches", () => {
    ...
    request.__setFhirResults(
      `${FHIR_BASE_URL}/Patient?_id=Patient/433ebeb6-1d89-4b64-97e6-a985675ca571,Patient/bc58707b-62f1-498a-8fb3-568cd5b69db2,Patient/d55e15fd-d7a6-42b8-89cc-560e3578ef7f`,
      null,
      JSON.stringify(require("./FHIRResources/unbreakmatchresources.json"))
    );
    request.__setFhirResults(
      `${FHIR_BASE_URL}/Patient?identifier=http://clientregistry.org/openmrs|patient1&_include=Patient:link`,
      null,
      JSON.stringify(
    ...
    request.__setFhirResults(
      `${FHIR_BASE_URL}/Patient?identifier=http://clientregistry.org/openmrs|patient2&_include=Patient:link`,
      null,
      JSON.stringify(
    ...
    request.__setFhirResults(
      ...
      null,
      require("./ESResources/refreshindex.json")
    );
    request.__setFhirResults(
      `${ES_BASE_URL}/_search`,
      require("./ESResources/decisionruleforpatient1.json"),
      require("./ESResources/searchresultsforpatient1.json")
    );
    request.__setFhirResults(
      `${ES_BASE_URL}/_search`,
      require("./ESResources/decisionruleforpatient2.json"),
      require("./ESResources/searchresultsforpatient2.json")
    );
    request.__setFhirResults(
      `${ES_BASE_URL}/_search`,
      require("./ESResources/decisionruleforpatient3.json"),
    ...
    request.__setFhirResults(
      ...
      null,
      JSON.stringify(require("./FHIRResources/patientreport.json"))
    );
    request.__setFhirResults(
      `${FHIR_BASE_URL}/StructureDefinition/Patient`,
      null,
      JSON.stringify(require("./FHIRResources/PatientStructureDefinition.json"))
    );
    ...
    axios.__setFhirResults(
      `${ES_BASE_URL}`,
      require("./ESResources/indexSettings.json"),
      {
        acknowledged: true,
    ...
    axios.__setFhirResults(
      ...
      require("./ESResources/indexMappings.json"),
      { acknowledged: true }
    );
    axios.__setFhirResults(
      `${ES_BASE_URL}/_doc/bc58707b-62f1-498a-8fb3-568cd5b69db2`,
      require("./ESResources/cacheRequest-bc58707b-62f1-498a-8fb3-568cd5b69db2.json"),
      require("./ESResources/cacheResults-bc58707b-62f1-498a-8fb3-568cd5b69db2.json")
    );
    axios.__setFhirResults(
      `${ES_BASE_URL}/_doc/d55e15fd-d7a6-42b8-89cc-560e3578ef7f`,
      require("./ESResources/cacheRequest-d55e15fd-d7a6-42b8-89cc-560e3578ef7f.json"),
      require("./ESResources/cacheResults-d55e15fd-d7a6-42b8-89cc-560e3578ef7f.json")
    );
    axios.__setFhirResults(
      `${ES_BASE_URL}/_doc/433ebeb6-1d89-4b64-97e6-a985675ca571`,
      require("./ESResources/cacheRequest-433ebeb6-1d89-4b64-97e6-a985675ca571.json"),
      require("./ESResources/cacheResults-433ebeb6-1d89-4b64-97e6-a985675ca571.json")
    );
    return supertest(app)
      .post("/unbreak-match")
      .send(ids)
  ...
  test("Testing Count Match Issues", () => {
    request.__setFhirResults(
      ...
      null,
      JSON.stringify(require("./FHIRResources/totalMatchIssues.json"))
    );
    return supertest(app)
  ...
  test("Testing Resolving Match Issues", () => {
    ...
    request.__setFhirResults(
      `${FHIR_BASE_URL}/Patient?_id=433ebeb6-1d89-4b64-97e6-a985675ca571,c49a52c1-88bc-41fb-9c87-bdd2a911f360,739d4023-40eb-4f44-8d14-3355926bd60d,bc58707b-62f1-498a-8fb3-568cd5b69db2,d55e15fd-d7a6-42b8-89cc-560e3578ef7f`,
      null,
      JSON.stringify(require("./FHIRResources/allMatchIssuesWithLinks.json"))
    );
    return supertest(app)
      .post("/resolve-match-issue")
      .send(resolveIssuesReqBundle)
      .then((response) => {
        expect(response.statusCode).toBe(200);
      });
  });
